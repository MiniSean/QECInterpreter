...
class ISyndromeDecoder(IDecoder, metaclass=ABCMeta):
    ...
    def get_binary_syndrome_correction(self, cycle_stabilizer_count: int) -> NDArray[np.int_]:
        ...
        # Pre-process
        eigenvalue_syndrome_corrections = ShotsClassifierContainer.binary_to_eigenvalue(syndrome_corrections)
        # (N, 1, D)
        ...
        # Post-process
        syndrome_correction = ShotsClassifierContainer.eigenvalue_to_binary(eigenvalue_syndrome_correction)
